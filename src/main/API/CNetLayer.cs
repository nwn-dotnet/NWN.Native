...
public class CNetLayer : global::System.IDisposable {
  ...
  public int GetAddressTranslationResult(CExoString sInternetAddress, SWIGTYPE_p_CExoArrayListT_unsigned_int_t nIPv4) {
    int ret = NWNXLibPINVOKE.CNetLayer_GetAddressTranslationResult(swigCPtr, CExoString.getCPtr(sInternetAddress), SWIGTYPE_p_CExoArrayListT_unsigned_int_t.getCPtr(nIPv4));
    if (NWNXLibPINVOKE.SWIGPendingException.Pending) throw NWNXLibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
