...
public class CNWSPlayerTURD : CNWSObject {
  ...
  public SWIGTYPE_p_CExoArrayListT_int_t m_pReputation {
    set {
      NWNXLibPINVOKE.CNWSPlayerTURD_m_pReputation_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_CNWSPersonalReputation_t m_pPersonalReputationList {
    set {
      NWNXLibPINVOKE.CNWSPlayerTURD_m_pPersonalReputationList_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CNWSPersonalReputation_t.getCPtr(value));
    } 
    get {
  ...
  public override void EventHandler(uint nEventId, uint nCallerObjectId, SWIGTYPE_p_void pScript, uint nCalendarDay, uint nTimeOfDay) {
    NWNXLibPINVOKE.CNWSPlayerTURD_EventHandler(swigCPtr, nEventId, nCallerObjectId, SWIGTYPE_p_void.getCPtr(pScript), nCalendarDay, nTimeOfDay);
  }
  ...
  public void SetReputation(SWIGTYPE_p_CExoArrayListT_int_t pRep) {
    NWNXLibPINVOKE.CNWSPlayerTURD_SetReputation(swigCPtr, SWIGTYPE_p_CExoArrayListT_int_t.getCPtr(pRep));
  }

  public void SetPersonalReputation(SWIGTYPE_p_CExoArrayListT_CNWSPersonalReputation_t pRep) {
    NWNXLibPINVOKE.CNWSPlayerTURD_SetPersonalReputation(swigCPtr, SWIGTYPE_p_CExoArrayListT_CNWSPersonalReputation_t.getCPtr(pRep));
  }

  public void CopyEffectList(SWIGTYPE_p_CExoArrayListT_CGameEffect_p_t pEffectList) {
    NWNXLibPINVOKE.CNWSPlayerTURD_CopyEffectList(swigCPtr, SWIGTYPE_p_CExoArrayListT_CGameEffect_p_t.getCPtr(pEffectList));
  }

  public void CopyAutomapData(int nNumAreas, SWIGTYPE_p_CExoArrayListT_unsigned_int_t pAreaList, SWIGTYPE_p_p_unsigned_char pAreaData) {
    NWNXLibPINVOKE.CNWSPlayerTURD_CopyAutomapData(swigCPtr, nNumAreas, SWIGTYPE_p_CExoArrayListT_unsigned_int_t.getCPtr(pAreaList), SWIGTYPE_p_p_unsigned_char.getCPtr(pAreaData));
  }
