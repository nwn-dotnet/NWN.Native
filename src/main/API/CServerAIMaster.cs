...
public class CServerAIMaster : global::System.IDisposable {
  ...
  public SWIGTYPE_p_CServerExoAppInternal m_pExoAppInternal {
    set {
      NWNXLibPINVOKE.CServerAIMaster_m_pExoAppInternal_set(swigCPtr, SWIGTYPE_p_CServerExoAppInternal.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoLinkedListT_CServerAIEventNode_t m_lEventQueue {
    set {
      NWNXLibPINVOKE.CServerAIMaster_m_lEventQueue_set(swigCPtr, SWIGTYPE_p_CExoLinkedListT_CServerAIEventNode_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = NWNXLibPINVOKE.CServerAIMaster_m_lEventQueue_get(swigCPtr);
      SWIGTYPE_p_CExoLinkedListT_CServerAIEventNode_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_CExoLinkedListT_CServerAIEventNode_t(cPtr, false);
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_CExoArrayListT_int_t m_pAttackRepAdj {
    set {
      NWNXLibPINVOKE.CServerAIMaster_m_pAttackRepAdj_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_int_t m_pTheftRepAdj {
    set {
      NWNXLibPINVOKE.CServerAIMaster_m_pTheftRepAdj_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_int_t m_pKillRepAdj {
    set {
      NWNXLibPINVOKE.CServerAIMaster_m_pKillRepAdj_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_int_t m_pHelpRepAdj {
    set {
      NWNXLibPINVOKE.CServerAIMaster_m_pHelpRepAdj_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_int_t.getCPtr(value));
    } 
    get {
  ...
  public void SetExoAppInternal(SWIGTYPE_p_CServerExoAppInternal pExoAppInternal) {
    NWNXLibPINVOKE.CServerAIMaster_SetExoAppInternal(swigCPtr, SWIGTYPE_p_CServerExoAppInternal.getCPtr(pExoAppInternal));
  }
