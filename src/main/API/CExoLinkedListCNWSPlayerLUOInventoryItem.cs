...
/*@SWIG@*/
  ...
  public uint Count() {
    uint retVal = NWNXLibPINVOKE.CExoLinkedListCNWSPlayerLUOInventoryItem_Count(swigCPtr);
    return retVal;
  }
  ...
  public int IsEmpty() {
    int retVal = NWNXLibPINVOKE.CExoLinkedListCNWSPlayerLUOInventoryItem_IsEmpty(swigCPtr);
    return retVal;
  }
