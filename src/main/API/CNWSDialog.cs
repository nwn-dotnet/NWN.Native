...
public class CNWSDialog : global::System.IDisposable {
  ...
  public SWIGTYPE_p_CExoLinkedListT_CNWSDialogPlayer_t m_lPlayers {
    set {
      NWNXLibPINVOKE.CNWSDialog_m_lPlayers_set(swigCPtr, SWIGTYPE_p_CExoLinkedListT_CNWSDialogPlayer_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = NWNXLibPINVOKE.CNWSDialog_m_lPlayers_get(swigCPtr);
      SWIGTYPE_p_CExoLinkedListT_CNWSDialogPlayer_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_CExoLinkedListT_CNWSDialogPlayer_t(cPtr, false);
      return ret;
    } 
  }
  ...
  public int CheckScript(CNWSObject pNWSObjectSpeaker, CResRef sActive, SWIGTYPE_p_CExoArrayListT_ScriptParam_t scriptParams) {
    int ret = NWNXLibPINVOKE.CNWSDialog_CheckScript(swigCPtr, CNWSObject.getCPtr(pNWSObjectSpeaker), CResRef.getCPtr(sActive), SWIGTYPE_p_CExoArrayListT_ScriptParam_t.getCPtr(scriptParams));
    if (NWNXLibPINVOKE.SWIGPendingException.Pending) throw NWNXLibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void RunScript(CNWSObject pNWSObjectSpeaker, CResRef sScript, SWIGTYPE_p_CExoArrayListT_ScriptParam_t scriptParams) {
    NWNXLibPINVOKE.CNWSDialog_RunScript(swigCPtr, CNWSObject.getCPtr(pNWSObjectSpeaker), CResRef.getCPtr(sScript), SWIGTYPE_p_CExoArrayListT_ScriptParam_t.getCPtr(scriptParams));
    if (NWNXLibPINVOKE.SWIGPendingException.Pending) throw NWNXLibPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public int GetStartEntryOneLiner(CNWSObject pNWSObjectOwner, CExoLocString sOneLiner, CResRef sSound, CResRef sScript, SWIGTYPE_p_CExoArrayListT_ScriptParam_t scriptParams) {
    int ret = NWNXLibPINVOKE.CNWSDialog_GetStartEntryOneLiner(swigCPtr, CNWSObject.getCPtr(pNWSObjectOwner), CExoLocString.getCPtr(sOneLiner), CResRef.getCPtr(sSound), CResRef.getCPtr(sScript), SWIGTYPE_p_CExoArrayListT_ScriptParam_t.getCPtr(scriptParams));
    if (NWNXLibPINVOKE.SWIGPendingException.Pending) throw NWNXLibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void LoadScriptParams(CResGFF pRes, SWIGTYPE_p_CExoArrayListT_ScriptParam_t paramsList, CResStruct pStructure, string szFieldID) {
    NWNXLibPINVOKE.CNWSDialog_LoadScriptParams(swigCPtr, CResGFF.getCPtr(pRes), SWIGTYPE_p_CExoArrayListT_ScriptParam_t.getCPtr(paramsList), CResStruct.getCPtr(pStructure), szFieldID);
    if (NWNXLibPINVOKE.SWIGPendingException.Pending) throw NWNXLibPINVOKE.SWIGPendingException.Retrieve();
  }
