...
public class CNWLevelStats : global::System.IDisposable {
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_int_t m_pAddedKnownSpellList {
    set {
      NWNXLibPINVOKE.CNWLevelStats_m_pAddedKnownSpellList_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_int_t m_pRemovedKnownSpellList {
    set {
      NWNXLibPINVOKE.CNWLevelStats_m_pRemovedKnownSpellList_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_short_t m_lstFeats {
    set {
      NWNXLibPINVOKE.CNWLevelStats_m_lstFeats_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_short_t.getCPtr(value));
    } 
    get {
