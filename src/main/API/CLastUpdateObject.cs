...
public class CLastUpdateObject : global::System.IDisposable {
  ...
  public SWIGTYPE_p_CExoArrayListT_CLoopingVisualEffect_p_t m_lstLoopingVisualEffects {
    set {
      NWNXLibPINVOKE.CLastUpdateObject_m_lstLoopingVisualEffects_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CLoopingVisualEffect_p_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_int_t m_poidCreatureList {
    set {
      NWNXLibPINVOKE.CLastUpdateObject_m_poidCreatureList_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_MaterialShaderParam_t m_lMaterialShaderParameters {
    set {
      NWNXLibPINVOKE.CLastUpdateObject_m_lMaterialShaderParameters_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_MaterialShaderParam_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_TextureReplaceInfo_t m_lTextureReplaceInfo {
    set {
      NWNXLibPINVOKE.CLastUpdateObject_m_lTextureReplaceInfo_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_TextureReplaceInfo_t.getCPtr(value));
    } 
    get {
