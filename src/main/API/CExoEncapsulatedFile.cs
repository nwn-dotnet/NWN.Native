...
public unsafe class CExoEncapsulatedFile : CExoPackedFile {
  ...
  public CExoEncapsulatedFile(void* cPtr, bool cMemoryOwn) : base(NWNXLibPINVOKE.CExoEncapsulatedFile_SWIGUpcast((global::System.IntPtr)cPtr), cMemoryOwn) {
  ...
  public override int LoadHeader(string expectOid, byte nType) {
    int ret = NWNXLibPINVOKE.CExoEncapsulatedFile_LoadHeader__SWIG_0(swigCPtr, expectOid, nType);
    return ret;
  }

  public override int LoadHeader(string expectOid) {
    int ret = NWNXLibPINVOKE.CExoEncapsulatedFile_LoadHeader__SWIG_1(swigCPtr, expectOid);
    return ret;
  }
