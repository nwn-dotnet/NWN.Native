...
public class CNWSAmbientSound : CNWAmbientSound {
  ...
  public int GetPlayersInArea(SWIGTYPE_p_CExoArrayListT_unsigned_int_t pList) {
    int ret = NWNXLibPINVOKE.CNWSAmbientSound_GetPlayersInArea(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_int_t.getCPtr(pList));
    return ret;
  }
