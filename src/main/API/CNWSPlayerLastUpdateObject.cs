...
public class CNWSPlayerLastUpdateObject : global::System.IDisposable {
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_short_t m_lstFeats {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstFeats_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_short_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_short_t m_lstBonusFeats {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstBonusFeats_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_short_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_CFeatUseListEntry_p_t m_lstFeatUses {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstFeatUses_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CFeatUseListEntry_p_t.getCPtr(value));
    } 
    get {
  ...
  public CNWActionNode m_pActionQueueList {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_pActionQueueList_set(swigCPtr, CNWActionNode.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_CNWVisibilityNode_p_t m_lstVisibilityList {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstVisibilityList_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CNWVisibilityNode_p_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_int_t m_lstKnownSpellsToDelete {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstKnownSpellsToDelete_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_int_t m_lstKnownSpellsToAdd {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstKnownSpellsToAdd_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_unsigned_int_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_CSpell_Delete_p_t m_lstMemorizedSpellsToDelete {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstMemorizedSpellsToDelete_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CSpell_Delete_p_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstMemorizedSpellsToDelete_get(swigCPtr);
      SWIGTYPE_p_CExoArrayListT_CSpell_Delete_p_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_CExoArrayListT_CSpell_Delete_p_t(cPtr, false);
      return ret;
    } 
  }

  public SWIGTYPE_p_CExoArrayListT_CSpell_Add_p_t m_lstMemorizedSpellsToAdd {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstMemorizedSpellsToAdd_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CSpell_Add_p_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_lstMemorizedSpellsToAdd_get(swigCPtr);
      SWIGTYPE_p_CExoArrayListT_CSpell_Add_p_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_CExoArrayListT_CSpell_Add_p_t(cPtr, false);
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_CExoArrayListT_CEffectIconObject_p_t m_aEffectIcons {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_aEffectIcons_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CEffectIconObject_p_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_CNWSStats_SpellLikeAbility_t m_pSpellLikeAbilityList {
    set {
      NWNXLibPINVOKE.CNWSPlayerLastUpdateObject_m_pSpellLikeAbilityList_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CNWSStats_SpellLikeAbility_t.getCPtr(value));
    } 
    get {
