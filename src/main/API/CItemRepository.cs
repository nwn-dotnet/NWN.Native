...
public class CItemRepository : global::System.IDisposable {
  ...
  public SWIGTYPE_p_CExoLinkedListT_unsigned_int_t m_oidItems {
    set {
      NWNXLibPINVOKE.CItemRepository_m_oidItems_set(swigCPtr, SWIGTYPE_p_CExoLinkedListT_unsigned_int_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = NWNXLibPINVOKE.CItemRepository_m_oidItems_get(swigCPtr);
      SWIGTYPE_p_CExoLinkedListT_unsigned_int_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_CExoLinkedListT_unsigned_int_t(cPtr, false);
      return ret;
    } 
  }
