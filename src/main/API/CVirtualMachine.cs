...
public class CVirtualMachine : global::System.IDisposable {
  ...
  public SWIGTYPE_p_CExoArrayListT_ScriptParam_t m_lScriptParams {
    set {
      NWNXLibPINVOKE.CVirtualMachine_m_lScriptParams_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_ScriptParam_t.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_CExoArrayListT_CScriptLog_p_t m_aScriptLog {
    set {
      NWNXLibPINVOKE.CVirtualMachine_m_aScriptLog_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CScriptLog_p_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = NWNXLibPINVOKE.CVirtualMachine_m_aScriptLog_get(swigCPtr);
      SWIGTYPE_p_CExoArrayListT_CScriptLog_p_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_CExoArrayListT_CScriptLog_p_t(cPtr, false);
      return ret;
    } 
  }
  ...
  public void SetScriptParameters(SWIGTYPE_p_CExoArrayListT_ScriptParam_t lParameters) {
    NWNXLibPINVOKE.CVirtualMachine_SetScriptParameters(swigCPtr, SWIGTYPE_p_CExoArrayListT_ScriptParam_t.getCPtr(lParameters));
    if (NWNXLibPINVOKE.SWIGPendingException.Pending) throw NWNXLibPINVOKE.SWIGPendingException.Retrieve();
  }
