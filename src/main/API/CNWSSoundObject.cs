...
public class CNWSSoundObject : CNWSObject {
  ...
  public SWIGTYPE_p_CExoArrayListT_CResRef_t m_SoundList {
    set {
      NWNXLibPINVOKE.CNWSSoundObject_m_SoundList_set(swigCPtr, SWIGTYPE_p_CExoArrayListT_CResRef_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = NWNXLibPINVOKE.CNWSSoundObject_m_SoundList_get(swigCPtr);
      SWIGTYPE_p_CExoArrayListT_CResRef_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_CExoArrayListT_CResRef_t(cPtr, false);
      return ret;
    } 
  }
  ...
  public override void EventHandler(uint nEventId, uint nCallerObjectId, SWIGTYPE_p_void pScript, uint nCalendarDay, uint nTimeOfDay) {
    NWNXLibPINVOKE.CNWSSoundObject_EventHandler(swigCPtr, nEventId, nCallerObjectId, SWIGTYPE_p_void.getCPtr(pScript), nCalendarDay, nTimeOfDay);
  }
  ...
  public SWIGTYPE_p_CExoArrayListT_unsigned_int_t GetPeopleInSoundRange() {
    SWIGTYPE_p_CExoArrayListT_unsigned_int_t ret = new SWIGTYPE_p_CExoArrayListT_unsigned_int_t(NWNXLibPINVOKE.CNWSSoundObject_GetPeopleInSoundRange(swigCPtr), true);
    return ret;
  }
