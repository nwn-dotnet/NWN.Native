...
public static unsafe class NWNXLib {
  ...
  public static readonly int CSCRIPTCOMPILER_OPTIMIZE_DEAD_BRANCHES = NWNXLibPINVOKE.CSCRIPTCOMPILER_OPTIMIZE_DEAD_BRANCHES_get();
  public static readonly int CSCRIPTCOMPILER_OPTIMIZE_NOTHING = NWNXLibPINVOKE.CSCRIPTCOMPILER_OPTIMIZE_NOTHING_get();
  public static readonly int CSCRIPTCOMPILER_OPTIMIZE_SAFE = NWNXLibPINVOKE.CSCRIPTCOMPILER_OPTIMIZE_SAFE_get();
  public static readonly int CSCRIPTCOMPILER_OPTIMIZE_AGGRESSIVE = NWNXLibPINVOKE.CSCRIPTCOMPILER_OPTIMIZE_AGGRESSIVE_get();
  public static readonly int CSCRIPTCOMPILER_OPTIMIZE_EXPERIMENTAL = NWNXLibPINVOKE.CSCRIPTCOMPILER_OPTIMIZE_EXPERIMENTAL_get();
